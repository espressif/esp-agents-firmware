...
set(BOARD_MANAGER_DEFAULTS "${GEN_BMGR_CODES_PATH}/board_manager.defaults")
if(EXISTS ${BOARD_MANAGER_DEFAULTS})
    list(APPEND SDKCONFIG_DEFAULTS ${BOARD_MANAGER_DEFAULTS})
    message(STATUS "Added ${BOARD_MANAGER_DEFAULTS} to SDKCONFIG_DEFAULTS")
endif()
