...
The fastest way to get started is to get the ESP RainMaker Home app from the respective app stores:
...
* You can interrupt the agent anytime by briefly tapping on the screen.
