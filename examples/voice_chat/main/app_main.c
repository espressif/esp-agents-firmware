...
void app_main(void)
{
    ...
    /* State machine. This gets events from event_handler, audio_pipeline, etc. On receiving the event, the appropriate callbacks are called.
     * The default behaviour can be overridden by changing the callbacks.
     */
